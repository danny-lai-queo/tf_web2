...
from imglib_fastai import processImg
from imglib_fastai import get_inf
from imglib_fastai import processImg_with_inf
...
def run_batch():
    ...
    for img_path in all_imgs:
        ...
        # actual_dx, pct = processImg_with_inf(os.path.join(test_images_path, img_base_name), learn_inf)
        print(f"actual_dx={actual_dx}, pct={pct}% , expected_dx={expected_dx}")
